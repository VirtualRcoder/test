...
<ul>
  ...
  <li style={{float:'left', listStyleType:'None', margin:'0px 0px 0px 0px'}}>
  ...
  <li style={{float:'left', listStyleType:'None', margin:'0px 0px 0px 50px'}}>
...
<div className="shadow-box-example hoverable">
  <li style={{float:'left',listStyleType:'None' ,margin:'15px 0px 0px 50px'}} >
  ...
  <li style={{float:'left',listStyleType:'None',margin:'6px 0px 0px 50px'}}>
  ...
  <li style={{float:'left',listStyleType:'None',margin:'10px 0px 0px 50px'}}>
